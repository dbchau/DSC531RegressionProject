...
%macro ModelSelect(library=work, dataset=, response=, inter=N, hier=Y, method=stepwise, select=aic, stop=aic, choose=aic, outputData=);
...
%ModelSelect(dataset=regmodel, response=rate, select=aic, stop=aic, choose=aic, outputData=out4);
%ModelSelect(dataset=regmodel, response=rate, select=bic, stop=bic, choose=bic, outputData=out5);
%ModelSelect(dataset=regmodel, response=rate, inter=yes, hier=no, select=sbc, stop=sbc, choose=sbc, outputData=out6);
%ModelSelect(dataset=regmodel, response=rate, select=aic, stop=aic, choose=aic, inter=no, hier=yes, outputData=out7);
%ModelSelect(dataset=regmodel, response=rate,  select=sbc, stop=aic, choose=aic, inter=yes, hier=yes, outputData=out8);
...
c21enprf
;
%ModelSelect(dataset=regmodel,response=rate,choose=SBC,outputData=out9,inter=yes,hier=no);
%ModelSelect(dataset=regmodel, response=rate, select=aic, stop=aic, choose=aic, inter=no, hier=yes, outputData=out10);
